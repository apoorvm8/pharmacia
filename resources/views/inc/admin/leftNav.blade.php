<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{active(['users.*'])}}" style="{{ Auth::guard('admin')->user()->role != 'admin' ? 'display:none' : ''}}">
                <a href="javascript:void(0);" class="menu-toggle">
                ...
                <ul class="ml-menu">
                    <li class="{{active('users.verified')}}">
                        <a href="{{route('users.verified', ['admin' => 'admin'])}}">Verified Users</a>
                    </li>
                    <li class="{{active('users.intermediate')}}">
                        <a href="{{route('users.intermediate', ['admin' => 'admin'])}}">Intermediate Users</a>
                    </li>
                    <li class="{{active('users.unverified')}}">
                        <a href="{{route('users.unverified', ['admin' => 'admin'])}}">Unverified Users</a>
                    </li>
                    <li class="{{active('users.blacklist')}}">
                        <a href="{{route('users.blacklist', ['admin' => 'admin'])}}">Blacklisted Users</a>
                    </li>
                </ul>
                
            </li>
            {{-- @endif --}}
            <li class="{{active(['orders.*'])}}" style="{{ Auth::guard('admin')->user()->role != 'admin' ? 'display:none' : ''}}">
                <a href="javascript:void(0);" class="menu-toggle">
                ...
                <ul class="ml-menu">
                    <li class="{{active('orders.byVerified')}}">
                        <a href="{{route('orders.byVerified', ['admin' => 'admin'])}}">By Verified Users</a>
                    </li>
                    <li class="{{active('orders.byIntermediate')}}">
                        <a href="{{route('orders.byIntermediate', ['admin' => 'admin'])}}">By Intermediate Users</a>
                    </li>
                    <li class="{{active('orders.byUnverified')}}">
                        <a href="{{route('orders.byUnverified', ['admin' => 'admin'])}}">By Unverified Users</a>
                    </li>
                </ul>
