        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    ...
                    <small>List of all unverified users present in record</small>
                               ...
                               @foreach($users as $user) 
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    {{$user->gstNo != null ? $user->gstNo : 'Not Added'}}
                                                </div>
                                            </div>
                                            @if($user->gstNo != null)
                                                <div class="row">
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    {{$user->drugNo != null ? $user->drugNo : "Not Added"}}
                                                </div>
                                            </div>
                                            <div class="row">
                                                @if($user->drugNo != null)
                                        ...
                                        <td>
                                            <form>
                                                ...
                                                <input type="submit" value="Remove" class="removeBtn btn btn-danger btn-sm">
                                            </form>
                                        </td>
                                        <td>
                                            <form class="blacklistForm" action="{{route('users.unverified.update', ['admin' => 'admin'])}}" method="POST">
                                                @csrf
                                                <input type="hidden" name="_method" value="PUT">
                                                <input type="hidden" name="blacklistId" value="{{$user->id}}">
                                                <input type="submit" value="Blacklist" class="blacklistBtn btn btn-default btn-sm">
                                            </form>
                                        </td>
