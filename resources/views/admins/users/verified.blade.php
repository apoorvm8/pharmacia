        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    ...
                    <small>List of all verified users present in record</small>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    {{$user->verificationStatus == 2 ? 'Verified' : ''}}
                                                </div>
                                            </div>
                                            @if($user->gstNo != null)
                                                <div class="row">
                                        ...
                                        <td>
                                            <form>
                                                ...
                                                <input type="button" value="Blacklist" class="btn btn-default btn-sm">
                                            </form>
                                        </td>
